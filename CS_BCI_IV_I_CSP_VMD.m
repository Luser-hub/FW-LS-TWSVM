...
subj_list = { ...
    [29, 45, 21, 27, 28, 35], ...     % subj_a
    [29 38 37 43 44 45 12 36 28 27 19 20 21 35 42 18 46 11 30 13 50 52], ... % subj_b
    [29 18 26 21 35 37 38 42 45], ... % subj_f
    [29 27 35 37 43 44 20 45 36 38] ... % subj_g
};
subj_names = {'a', 'b', 'f', 'g'};  
% 每个被试
for subj = 1:4
...
%         random_indices = randperm(sample_dim);        
    ...
    for i = 1:8
        EEGSignal = struct('x',reshape(result{i},[all_data_shape(3),all_data_shape(2),all_data_shape(1)]),'y',subj_label_array);
...
%         final_index = index(1:numberOfFeatures,:);
        ...
        file_name = sprintf('CSsubj%s.mat', subj_names{subj});
